            ...
            case 'objects':
                ...
                case 'chapters':
                    ...
                    <div class="mb-3">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ${result.temas_principales ? result.temas_principales.slice(0, 3).map(tema =>
                                    `<span class="text-xs bg-purple-600 text-white px-2 py-1 rounded-full">${tema}</span>`
                                ).join('') : '<span class="text-gray-400 text-xs">No disponible</span>'}
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <p class="text-gray-300 text-sm italic">
                            ${result.eventos_relacionados ? result.eventos_relacionados.slice(0, 3).map(evento =>                                
                                `${evento.nombre}` 
                            ).join(', ') : 'No disponible'}
                        </p>
                    </div>
                ...
                case 'relationships':
                    ...
                    <div class="mb-3">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            ${result.relaciones ? result.relaciones.slice(0, 3).map(relacion =>
                                    `<li class="text-xs text-white px-2 py-1 rounded-full">${relacion.descripcion}. (${relacion.tipo})</li>`
                                ).join('') : '<span class="text-gray-400 text-xs">No disponible</span>'}
                            </ol>
                        </div>
                    </div>
                ...
                case 'symbols':
                    ...
                    <div class="mb-3">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ${result.elementos_asociados ? result.elementos_asociados.slice(0, 3).map(elemento =>
                                    `<span class="text-xs bg-purple-600 text-white px-2 py-1 rounded-full">${elemento}</span>`
                                ).join('') : '<span class="text-gray-400 text-xs">No disponible</span>'}
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ${result.interpretaciones ? result.interpretaciones.slice(0, 3).map(interpretacion =>
                                    `<li class="text-xs text-white px-2 py-1 rounded-full">${interpretacion}. (${interpretacion})</li>`
                                ).join('') : '<span class="text-gray-400 text-xs">No disponible</span>'}
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <p class="text-gray-300 text-sm italic">
                            <div class="flex flex-wrap gap-2">
                            ${result.personajes_afectados ? result.personajes_afectados.slice(0, 3).map(afectado =>
                                    `<span class="text-xs bg-purple-600 text-white px-2 py-1 rounded-full">${afectado}</span>`
                                ).join('') : '<span class="text-gray-400 text-xs">No disponible</span>'}
                        </div>
                        </p>
                    </div>
